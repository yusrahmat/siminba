                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" action="" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input type="text" id="fullname" name="fullname" required="required" class="form-control col-md-7 col-xs-12" placeholder="Fullname">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 btn-group">
                          <button type="submit" class="btn btn-primary" name="create-bag_gudang"><span class="fa fa-save"></span> Save</button>
                          <button type="reset" class="btn btn-default"><span class="fa fa-eraser"></span> Cancel</button>
                          <a href="?user=bag_gudang" class="btn btn-info"><span class="fa fa-reply"></span> Back</a>
                        </div>                   
                      </div>
                    </form>
                  </div>
