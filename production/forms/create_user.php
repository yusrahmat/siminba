                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" action="" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input type="text" id="id-user" name="id_user" value="<?php echo $id_user_baru; ?>" class="form-control col-md-7 col-xs-12" readonly>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" id="username" name="username" required class="form-control col-md-7 col-xs-12" placeholder="Username">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input type="text" id="fullname" name="fullname" required class="form-control col-md-7 col-xs-12" placeholder="Fullname">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <select class="form-control" name="akses">
                            ...
                            <option value="bag.gudang">Bag. Gudang</option>
                          </select>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 btn-group">
                          <button type="submit" class="btn btn-primary" name="create-user"><span class="fa fa-save"></span> Save</button>
