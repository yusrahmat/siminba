                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input type="text" id="kode-barang" name="kode_barang" value="<?php echo $kode_baru_bar; ?>" class="form-control col-md-7 col-xs-12" readonly>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" id="nama-barang" name="nama_barang" required="required" class="form-control col-md-7 col-xs-12" placeholder="Nama Barang">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <select class="form-control" name="satuan" required>
                            ...
                            ?>
                            <option value="<?php echo $data['nama_satuan']; ?>"><?php echo $data['nama_satuan']; ?></option>
                            <?php
                              }
                            ?>
                          </select>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input type="text" id="jumlah" name="jumlah" class="form-control col-md-7 col-xs-12" placeholder="0" readonly>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 btn-group">
                          <button type="submit" class="btn btn-primary" name="create-barang"><span class="fa fa-save"></span> Save</button>
