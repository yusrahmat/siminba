                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="no-terima" name="no_terima" value="<?php echo $kode_baru_terima; ?>" class="form-control col-md-7 col-xs-12" readonly>     
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <input type="text" id="no-reff" name="no_reff" required="required" class="form-control col-md-7 col-xs-12" placeholde="No. Reff">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="stok-awal">Stok Awal<span class="required">*</span>
                        </label>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <input type="number" id="jumlah-terima" name="jumlah_terima" required="required" class="form-control col-md-7 col-xs-12" placeholder="Diterima">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 btn-group">
                          <button type="submit" class="btn btn-primary" name="create-penerimaan"><span class="fa fa-save"></span> Save</button>
