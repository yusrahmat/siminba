              ...
              <div class="title_left">
                <h3>
                  <ol class="breadcrumb">
                    ...
                    <li class="active">Form Customers</li>
                  </ol>
                </h3>
              </div>
            </div>
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input type="text" id="kode-customer" name="kode_customer" value="<?php echo $kode_baru_cust; ?>" class="form-control col-md-7 col-xs-12" readonly>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="nama-customer" name="nama_customer" required="required" class="form-control col-md-7 col-xs-12" placeholder="Nama Supplier">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 btn-group">
                          <button type="submit" class="btn btn-primary" name="create-customer"><span class="fa fa-save"></span> Save</button>
