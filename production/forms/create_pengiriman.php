                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="" method="post">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="no_minta">No. Kirim <span class="required">*</span>
                        </label>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                        <input type="text" id="no-kirim" name="no_kirim" value="<?php echo $kode_baru_kirim; ?>" class="form-control col-md-7 col-xs-12" readonly>     
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Tanggal Kirim<span class="required">*</span></label>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <input type='text' name="tanggal_kirim" class="form-control" id='tanggal' required/>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <input type="text" id="no_reff" name="no_reff" required="required" class="form-control col-md-7 col-xs-12" placeholder="No. Reff">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Tanggal Minta<span class="required">*</span></label>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <input type='text' name="tanggal_minta" class="form-control" id='tanggal_minta' required/>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Kode Customer<span class="required">*</span></label>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <?php
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <input type="number" id="jumlah-minta" name="jumlah_minta" required="required" class="form-control col-md-7 col-xs-12" placeholder="Jumlah Diminta">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <input type="number" id="jumlah-kirim" name="jumlah_kirim" required="required" class="form-control col-md-7 col-xs-12" placeholder="Jumlah Dikirim">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 btn-group">
                          <button type="submit" class="btn btn-primary" name="create-pengiriman"><span class="fa fa-save"></span> Save</button>
